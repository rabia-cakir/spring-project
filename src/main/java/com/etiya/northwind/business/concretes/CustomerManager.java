...
public class CustomerManager implements CustomerService {
   ...
   /*    List<Customer> results = customerRepository.findAll();
        List<CustomerListResponse> response = results.stream().map(customer -> this.modelMapperService.forResponse()
...
*/
      List<Customer> result=customerRepository.findAll();
        ...
        for(Customer customer:result)
        {
            ...
            customerListResponse.setCityId(customer.getCity().getCityId());
            customerListResponse.setCountryId(customer.getCountry().getCountry_id());
