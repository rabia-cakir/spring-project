...
*/
        ...
        List<CartDetail> result=cartDetailRepository.findAll();
        List<CartDetailListResponse> response=new ArrayList<>();
        for(CartDetail cartDetail:result)
        {
           CartDetailListResponse cartDetailListResponse=new CartDetailListResponse();
           cartDetailListResponse.setCartDetailId(cartDetail.getCartDetailId());
           cartDetailListResponse.setCartId(cartDetail.getCart().getCartId());
           cartDetailListResponse.setProductId(cartDetail.getProduct().getProductId());
           cartDetailListResponse.setProductName(cartDetail.getProduct().getProductName());
           response.add(cartDetailListResponse);
        }
