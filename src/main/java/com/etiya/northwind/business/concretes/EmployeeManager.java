...
public class EmployeeManager implements EmployeeService {
    ...
    public Result add(CreateEmployeeRequest createEmployeeRequest) {
        checkIfReportLimitExceed(createEmployeeRequest.getReportsTo());
    ...
    private void checkIfReportLimitExceed(Integer reportId)
    {
        List<Employee> employees=this.employeeRepository.findByReportsTo(reportId);
